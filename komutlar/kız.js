...
exports.run = async (client, message, args) => {
    if(!message.member.roles.cache.has('770753352908406785')) return message.reply('Bu Komut İçin <&@id> Rolüne Sahip Olman Lazım')

  let verilecek = "770756010729144400"//KızRolİd
